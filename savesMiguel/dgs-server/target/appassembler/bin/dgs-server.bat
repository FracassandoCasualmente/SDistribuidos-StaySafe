...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="dgs-server" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.tecnico.staysafe.dgs.DgsServerApp %CMD_LINE_ARGS%
