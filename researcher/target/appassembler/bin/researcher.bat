...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="researcher" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.tecnico.staysafe.researcher.ResearcherApp %CMD_LINE_ARGS%
