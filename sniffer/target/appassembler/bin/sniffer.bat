...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="sniffer" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.tecnico.staysafe.sniffer.SnifferApp %CMD_LINE_ARGS%
