...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="journalist" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.tecnico.staysafe.journalist.JournalistApp %CMD_LINE_ARGS%
